  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <Form {...form}>
        <form
          onSubmit={onSubmit}
          className="w-4/5 h-4/6 border-1 flex flex-wrap shadow-2xl bg-background rounded-md shadow-slate-900 p-9"
        >
            <FormField
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <PhoneInput defaultCountry="PL" placeholder={t('phoneNumber')} {...field} />
                  </FormControl>
                  <FormMessage className="text-center" />
                </FormItem>
              )}
